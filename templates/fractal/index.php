...
<html xmlns="http://www.w3.org/1999/xhtml" 
   xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" >
	...
	<body>
		...
		<div id="bottom-bar">
				<ul>
					<li id="cookie-info"><?php echo JText::_('TPL_FRACTAL_COOKIE_INFO'); ?><span onclick="hideCookieInfo()">X</span></li>
					<li id="old-browser-info"><?php echo JText::_('TPL_FRACTAL_OLD_BROWSER'); ?><span onclick="hideOldBrowserInfo()">X</span></li>
				</ul>
		</div>
