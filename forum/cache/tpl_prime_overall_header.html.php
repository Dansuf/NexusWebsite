...
<head>
<?php $this->_tpldata['DEFINE']['.']['PRIME_BOARD_WIDTH'] = '80%'; ?>
...
<div class="topnav">
<div id="wrap2" style="width: <?php echo (isset($this->_tpldata['DEFINE']['.']['PRIME_BOARD_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['PRIME_BOARD_WIDTH'] : ''; ?>;">
<div class="navlink"><ul>
				<li><a href="../" accesskey="h">
...
<li><a href="<?php echo (isset($this->_rootref['S_LOGIN_ACTION'])) ? $this->_rootref['S_LOGIN_ACTION'] : ''; ?>" accesskey="h">
					<strong>Login</strong>
				</a></li>
<?php } if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?>
				...
				<li><a href="<?php echo (isset($this->_rootref['U_PROFILE'])) ? $this->_rootref['U_PROFILE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?>" accesskey="e">
					<strong><?php echo ((isset($this->_rootref['L_READ_PROFILE'])) ? $this->_rootref['L_READ_PROFILE'] : ((isset($user->lang['READ_PROFILE'])) ? $user->lang['READ_PROFILE'] : '{ READ_PROFILE }')); ?></strong>
				</a></li>
				...
				<?php } if (! $this->_rootref['S_USER_LOGGED_IN'] && $this->_rootref['S_REGISTER_ENABLED'] && ! ( $this->_rootref['S_SHOW_COPPA'] || $this->_rootref['S_REGISTRATION'] ) && ! $this->_rootref['S_IS_BOT']) {  ?>
				...
				<li><a href="<?php echo (isset($this->_rootref['U_ACP'])) ? $this->_rootref['U_ACP'] : ''; ?>">
					<strong>Admin</strong>
				</a></li>				
				...
				<li><a href="<?php echo (isset($this->_rootref['U_LOGIN_LOGOUT'])) ? $this->_rootref['U_LOGIN_LOGOUT'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_LOGIN_LOGOUT'])) ? $this->_rootref['L_LOGIN_LOGOUT'] : ((isset($user->lang['LOGIN_LOGOUT'])) ? $user->lang['LOGIN_LOGOUT'] : '{ LOGIN_LOGOUT }')); ?>" accesskey="x">
					<strong><?php echo ((isset($this->_rootref['L_LOGOUT'])) ? $this->_rootref['L_LOGOUT'] : ((isset($user->lang['LOGOUT'])) ? $user->lang['LOGOUT'] : '{ LOGOUT }')); ?></strong>
				</a></li>
				<?php } ?>			
</ul></div>
...
<!--<div class="navlink" style="float: right;">
        ...
        <div class="float-right">
            <div class="quicksearch" style="margin-top: -1px;">
...
<div id="wrap" style="width: <?php echo (isset($this->_tpldata['DEFINE']['.']['PRIME_BOARD_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['PRIME_BOARD_WIDTH'] : ''; ?>;">
	<a id="top" name="top" accesskey="t"></a>
	<div style="margin-bottom: -23px;"></div>

	<div class="prime-logo"><!--
	<a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="h"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/logo.png" alt="" /></a>-->
	</div>
