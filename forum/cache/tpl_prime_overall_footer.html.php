...
<div id="page-footer">
	...
	<div class="mainfooter">
		<div class="nav-foot" style="float: left;"><ul>
				<li><a href="http://www.phpbb.com/">
					<strong>phpBB® Forum Software</strong>
					<span>Powered by phpBB® Forum Software © phpBB Group</span>
				</a></li>		
		</ul></div>	
		<div class="nav-foot"><ul>	
				<li><a href="http://www.abhisheksrivastava.in/">
					<strong>Abhishek Srivastava</strong>
					<span>&copy; Original style created by Abhishek Srivastava</span>
				</a></li>
		</ul></div>		
	</div>	
