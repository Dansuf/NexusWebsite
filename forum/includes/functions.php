...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
	...
	//the following function is a copy by Dan Sufho/the Fractal team
	...
	$template->assign_vars(array(
		...
		// Custom - made by Dan Sufho/the Fractal team
		
		'S_TITLE'				=> $user->lang['S_TITLE'],
		'S_HOME'				=> $user->lang['S_HOME'],
		'S_NOTIFICATIONS'		=> $user->lang['S_NOTIFICATIONS'],
		'S_FRIENDS'				=> $user->lang['S_FRIENDS'],
		'S_NO_FRIENDS'			=> $user->lang['S_NO_FRIENDS'],
		'S_PROFILE'				=> $user->lang['S_PROFILE'],
		'S_COINS'				=> $user->lang['S_COINS'],
		'S_TIME_PLAYED'			=> $user->lang['S_TIME_PLAYED'],
		'S_MORE'				=> $user->lang['S_MORE'],
		'S_STATS'				=> $user->lang['S_STATS'],
		'S_OTHER'				=> $user->lang['S_OTHER'],
		'S_UCP'					=> $user->lang['S_UCP'],
		'S_CUSTOM_ACP'			=> $user->lang['S_CUSTOM_ACP'],
		'S_POSTS'				=> $user->lang['S_POSTS'],
		'S_DONATE'				=> $user->lang['S_DONATE'],
		'S_LOGOUT'				=> $user->lang['S_LOGOUT'],
		'S_PLAYERS'				=> $user->lang['S_PLAYERS'],
		'S_OLD_BROWSER'			=> $user->lang['S_OLD_BROWSER'],
		'S_COOKIE_INFO'			=> $user->lang['S_COOKIE_INFO'],
		'S_COPYRIGHT'			=> $user->lang['S_COPYRIGHT'],
		'U_HOME'				=> '../',
		'U_FRIENDS'				=> append_sid("{$phpbb_root_path}ucp.$phpEx", 'i=zebra&amp;mode=friends'),
